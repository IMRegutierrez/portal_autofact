                    ...
                    if (action === "timbrar") {
                        ...
                        if (recordType === 'salesorder') {
                            ...
                            if (facturaExistente && facturaExistente.length > 0) {
                                ...
                                facturaReutilizar.setValue({ fieldId: 'custbody_domiciliofiscalreceptor', value: fiscalValues.codigoPostal });
                                ...
                                nuevaFactura.setValue({ fieldId: 'custbody_domiciliofiscalreceptor', value: fiscalValues.codigoPostal });
                                // Método de pago por default (4) si viene vacío
                        ...
                        if (context.request.parameters.recordType !== 'salesorder') {
                            ...
                            facturaTimbrar.setValue({ fieldId: 'custbody_domiciliofiscalreceptor', value: context.request.parameters.custpage_codigo_postal_fiscal });
                            facturaTimbrar.save();
                        }
